...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../../../Desktop/MyChevy/flutter_module/.ios/Flutter/engine/Flutter.framework"
  ...
  install_framework "${PODS_ROOT}/../../../../Desktop/MyChevy/flutter_module/.ios/Flutter/App.framework"
fi
